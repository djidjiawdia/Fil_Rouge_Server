...
class GroupeCompetenceVoter extends Voter
{
    protected function supports($attribute, $subject)
    {
        ...
        return in_array($attribute, ['CREATE_GRPECOMPETENCE', 'VIEW_GRPECOMPETENCE', 'EDIT_GRPECOMPETENCE'])
